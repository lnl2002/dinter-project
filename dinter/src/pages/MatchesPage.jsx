...
function MatchesPage() {
    ...
    const onUserInfoUpdate = (userData) => {
    ...
    return (
        <div style={{ height: "100%", background: "#ececec;", borderLeft: "1px solid gray" }}>
            ...
            <div className='container-fluid d-flex justify-content-center align-items-center' style={{ height: "100vh" }}>
                <div className='card-container align-items-end'>
                    <div style={{
                        ...
                        <Draggable position={deltaPosition} defaultPosition={{ x: 0, y: 0 }} axis="both" onDrag={handleDragItem} onStop={handleStop}>
                            <div className='user-card d-flex justify-content-center'>
                                <img draggable={false} height={'100%'} src={listUser[currentUser].image} alt='error' />
                                <div className='user-card-info d-flex align-items-center justify-content-between' style={{ paddingBottom: '70px' }}>
                                    <div>
                                        <div>
                                            <p className='text-app'>{listUser[currentUser].name}</p>
                                        </div>
                                        <div className='d-flex'>
                                            ...
                                            <p className='text-app'>{listUser[currentUser].add}</p>
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div className='emotional-container' style={{ width: '400px', paddingBottom: '10px', gap: '60px' }}>
